...
namespace gnut
{
    ...
    public:
        ...
        double _map_dty = 0.0;
        double _ele = 0.0;
        //vector<double> _sod_metro;
        //vector<double> _zhd_metro;
        //vector<double> _zwd_metro;
        //vector<double> _sod_era5;
        //vector<double> _zhd_era5_bott;
        //vector<double> _zwd_era5_bott;
        //vector<double> _zhd_era5_top;
        //vector<double> _zhd_era5_top;

...
namespace great
{
    ...
    */
    ...
    /**
*@brief       Class for decode/encode mhm file
*/
    class LibGREAT_LIBRARY_EXPORT t_mhm : public t_gcoder
    {
    public:
        /**
        * @brief constructor.
        ...
        * @param[in]  sz       size of the buffer
        */
        explicit t_mhm(t_gsetbase* s, string version = "", int sz = DEFAULT_BUFFER_SIZE);
